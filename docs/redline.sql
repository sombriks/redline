...
VALUES (1, 'MENSAL'), (2, 'ANUAL'), (3, 'DIARIA');
...
VALUES (1, 'CARTEIRA'), (2, 'BANCO'), (3, 'CARTAO');
...
VALUES ('SALARIO'), ('BONUS'), ('EXTRA'), ('OUTROS'), ('GANHOS'), ('MERCADO'),
('RESTAURANTE'), ('DELIVERY'), ('ALUGUEL'), ('INTERNET'), ('TELEFONE'),
('VESTUARIO'), ('TRANSPORTE'), ('ASSINATURAS'), ('SERVICOS'), ('INVESTIMENTOS'),
('IMPREVISTOS'), ('ELETRONICOS'), ('LAZER'), ('SAUDE'), ('RESERVA');
